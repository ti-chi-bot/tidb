...
<<<<<<< HEAD:table/tables/partition.go
	case model.PartitionTypeHash:
=======
		if err != nil {
			return -1, err
...
>>>>>>> 1e24d396082 (*: Drop partition DDL handling for overlapping partitions during State Changes (#56082)):pkg/table/tables/partition.go
